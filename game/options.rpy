...
define config.name = _("ERAIDAproject")
...
define build.name = "ERAIDAproject"
...
define config.main_menu_music = "audio/menu/main_menu.ogg"
...
define config.save_directory = "ERAIDAproject-1667749578"
